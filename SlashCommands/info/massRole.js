                ...
                let amount = 0;
                    ...
                    let role = interaction.options.getRole('target')
                        var roleArray = [role.id]
                            ...
                            interaction.followUp({embeds:[new Discord.MessageEmbed().setColor('RED').setDescription('**Error! Try Again!**')]})
                        }


                    } else return interaction.followUp({ embeds: [new Discord.MessageEmbed().setColor('RED').setDescription('**You are missing the `MANAGE_ROLES` permission!**')] })
