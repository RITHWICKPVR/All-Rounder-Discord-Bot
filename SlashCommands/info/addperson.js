...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        } else return interaction.followUp({embeds:[new Discord.MessageEmbed().setColor('RED').setDescription('**You are missing `MANAGE_CHANNELS` permission!**')],ephemeral:true})
