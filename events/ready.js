...
client.on("ready", async () =>{
    ...
    async function meetingReminder() {
        ...
        let embed = new Discord.MessageEmbed().setColor('BLUE').setTitle('Team Meeting Reminder').setDescription('Gentle reminder to attend the mandatory team meeting on teams!').setFooter({text: 'Have A Good Day!'})
